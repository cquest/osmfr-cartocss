.points [zoom >= 13] {
  ...
  ::tourism {
    ...
    [tourism = 'information'][poi_type!='trail_blaze'][zoom >= 16] {
...
#text-poly [zoom >= 15] {
  ...
  [heritage = '1'][pixels>1000]::amenity,
  [amenity = 'place_of_worship'][pixels>1000]::amenity {
    [zoom >= 17] { text-name: "[name]"; }
    text-name: "[nom]";
    text-size: 10;
    text-fill: #000033;
  ...
  [natural = 'wood'][pixels>1000]::natural {
    [zoom >= 17] { text-name: "[name]"; }
    text-name: "[nom]";
    text-fill: #060;
    text-face-name: @oblique-fonts;
  ...
  [landuse = 'reservoir']::natural,
  [landuse = 'basin']::natural {
    [zoom >= 15],
    [pixels>1000] {
      [zoom >= 17] { text-name: "[name]"; }
      text-name: "[nom]";
  ...
  [man_made = 'lighthouse'][zoom >= 15]::other {
    text-name: "[name]";
    text-size: 9;
    text-fill: #000033;
    text-dy: 16;
  ...
  [amenity = 'clinic'][pixels>1000]::hospital,
  [amenity = 'clinic'][zoom >= 16]::hospital,
  [amenity = 'hospital'][pixels>1000]::hospital,
  ...
  [amenity = 'public_building']::amenity,
  [amenity = 'community_centre']::amenity,
  [amenity = 'social_facility']::amenity,
  ...
  [tourism = 'information'][information='guidepost'][zoom>=16]::tourism
  {
    text-name: "[name]";
    text-size: 9;
    text-dy: 10;
  ...
  [leisure = 'fitness_station']::shop,
  [amenity = 'vehicle_inspection']::shop,
  [amenity = 'marketplace']::shop,
  [shop != ''][shop != 'vacant']::shop {
		[zoom >= 17],
    [pixels>1000] {
			text-name: "[name]";
			text-size: 8;
  ...
  [man_made = 'windmill'][zoom >= 17]::other {
    text-name: "[name]";
    text-size: 9;
    text-fill: #734a08;
    text-dy: 12;
